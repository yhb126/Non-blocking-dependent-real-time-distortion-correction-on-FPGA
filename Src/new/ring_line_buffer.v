...
//------------------------------------------------------
    ...
    always @(posedge clk or negedge rst_n) begin
        if(!rst_n) begin
            ...
            if(corrected_flag & coor_en_q) begin
                if(x_temp_q != WIDTH)
                    case({y_temp_q[0],x_temp_q[0]})
                        2'b11:begin
                            enb1                        <= 1'b1;
                            enb2                        <= 1'b1;
                            enb3                        <= 1'b1;
                            enb4                        <= 1'b1;
                            addrb1                      <= addrb_temp + x_temp_q[15:1] + 1;
                            addrb2                      <= addrb_temp + x_temp_q[15:1] + 1;
                            addrb3                      <= addrb_temp + x_temp_q[15:1] + 1;
                            addrb4                      <= addrb_temp + x_temp_q[15:1] + 1;
                        end
                        2'b10:begin
                            enb1                        <= 1'b1;
                            enb2                        <= 1'b1;
                            ...
                            enb4                        <= 1'b1;
                            addrb1                      <= addrb_temp + x_temp_q[15:1] + 1;
                            addrb2                      <= addrb_temp + x_temp_q[15:1];
                            addrb3                      <= addrb_temp + x_temp_q[15:1] + 1;
                            addrb4                      <= addrb_temp + x_temp_q[15:1];
                        end
                        2'b01:begin
                            enb1                        <= 1'b1;
                            enb2                        <= 1'b1;
                            enb3                        <= 1'b1;
                            enb4                        <= 1'b1;
                            addrb1                      <= (y_temp == HEIGHT) ? ((rd_ptr[8:1] -1)*WIDTH_DIV + x_temp_q[15:1] + 1) :addrb_temp + x_temp_q[15:1] + 1;
                            addrb2                      <= (y_temp == HEIGHT) ? ((rd_ptr[8:1] -1)*WIDTH_DIV + x_temp_q[15:1] + 1) :addrb_temp + x_temp_q[15:1] + 1;
                            // addrb3                      <= (rd_ptr == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] + 1 : (rd_ptr[8:1] - 1)*WIDTH_DIV + x_temp_q[15:1] + 1;
                            // addrb4                      <= (rd_ptr == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] + 1 : (rd_ptr[8:1] - 1)*WIDTH_DIV + x_temp_q[15:1] + 1;
                            addrb3                      <= (rd_ptr_q == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] + 1 : addrb_temp + x_temp_q[15:1] - WIDTH_DIV + 1;
                            addrb4                      <= (rd_ptr_q == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] + 1 : addrb_temp + x_temp_q[15:1] - WIDTH_DIV + 1;
                        end
                        2'b00:begin
                            enb1                        <= 1'b1;
                            enb2                        <= 1'b1;
                            ...
                            enb4                        <= 1'b1;
                            addrb1                      <= (y_temp == HEIGHT) ? ((rd_ptr[8:1] -1)*WIDTH_DIV + x_temp_q[15:1] + 1) :addrb_temp + x_temp_q[15:1] + 1;
                            addrb2                      <= (y_temp == HEIGHT) ? ((rd_ptr[8:1] -1)*WIDTH_DIV + x_temp_q[15:1]) :addrb_temp + x_temp_q[15:1];
                            // addrb3                      <= (rd_ptr == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] +1: (rd_ptr[8:1] - 1)*WIDTH_DIV + x_temp_q[15:1] +1;
                            // addrb4                      <= (rd_ptr == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1]  : (rd_ptr[8:1] - 1)*WIDTH_DIV + x_temp_q[15:1];
                            addrb3                      <= (rd_ptr_q == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] +1: addrb_temp + x_temp_q[15:1] - WIDTH_DIV +1;
                            addrb4                      <= (rd_ptr_q == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1]  : addrb_temp + x_temp_q[15:1] - WIDTH_DIV;
                        end
                        default :begin
                            enb1                        <= 1'b0;
                            enb2                        <= 1'b0;
                    ...
                    2'b10:begin
                        ...
                        enb3                        <= 1'b1;
                        enb4                        <= 1'b1;
                        addrb1                      <= addrb_temp + (x_temp_q[15:1]-1) + 1;
                        addrb2                      <= addrb_temp + x_temp_q[15:1];
                        addrb3                      <= addrb_temp + (x_temp_q[15:1]-1) + 1;
                        addrb4                      <= addrb_temp + x_temp_q[15:1];
                    end
                    2'b01:begin
                        enb1                        <= 1'b1;
                    ...
                    2'b00:begin
                        ...
                        enb3                        <= 1'b1;
                        enb4                        <= 1'b1;
                        addrb1                      <= (y_temp == HEIGHT) ? ((rd_ptr[8:1] -1)*WIDTH_DIV + x_temp_q[15:1]) :addrb_temp + x_temp_q[15:1];
                        addrb2                      <= (y_temp == HEIGHT) ? ((rd_ptr[8:1] -1)*WIDTH_DIV + (x_temp_q[15:1]-1) + 1) :addrb_temp + (x_temp_q[15:1]-1) + 1;
                        // addrb3                      <= (rd_ptr == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] : (rd_ptr[8:1] - 1)*WIDTH_DIV + x_temp_q[15:1];
                        // addrb4                      <= (rd_ptr == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] + 1 : (rd_ptr[8:1] - 1)*WIDTH_DIV + x_temp_q[15:1];
                        addrb3                      <= (rd_ptr_q == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] :      addrb_temp + x_temp_q[15:1] - WIDTH_DIV;
                        addrb4                      <= (rd_ptr_q == 0) ? (DEPTH/2 -1)*WIDTH_DIV + x_temp_q[15:1] + 1 :  addrb_temp + x_temp_q[15:1] - WIDTH_DIV;
                    end
                    default :begin
                        enb1                        <= 1'b0;
                        enb2                        <= 1'b0;
    ...
    always @(posedge clk or negedge rst_n) begin
        if(!rst_n) begin
            ...
            pixel_out_en                        <= out_pixel_hsync_6q;
        end
    end
    ...
    always @(posedge clk or negedge rst_n) begin
        if(!rst_n) begin
            ...
            out_pixel_hsync_6q                  <= out_pixel_hsync_5q;
        end
    end
